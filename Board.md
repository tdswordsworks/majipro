...
### from 佐藤 20190903
上記に関することなのですが、今年度のスタッフ採用について、想定よりも社会人へ比重が傾いてしまっているため、
大学生の募集を継続して行っております。
それもあり、全メンバーでの顔合わせはできておらず、
おそらくプレまじプロでも実現は難しいと思っております。

そこで、LINE上にはなりますが簡易的な自己紹介をする方がメンバーをしれていいかなと思うのですが、いかがでしょうか？
下記のような内容をイメージしておりました。
...
プログラムの話し合いで、プレまじプロの3日目のコンテンツに伴走者向けの
スキル研修（チームビルディング・ファシリ等）の時間を設けようという話になっています。
そこで、こちらの話し合いではここのコンテンツはプログラムチームではなく
伴走統括のメンバーにお願いした方がよいのでは？という意見になりました。

具体的な時間はまだ決めていないのですが、この部分って講師お願いできないでしょうか？
00:37
 ＞佐藤さん？野並さん？

Chatwork、LINEといくつかグループありますが、伴走運営全員をカバーしている
ものがまだないと佐藤さんに聞きました。悩んでいる人への意思決定の促し含めて
メンバー固めてグループ（おそらくLINE？）に全員入れるのは佐藤さんか野並さんが
やってくれると思っていてよいでしょうか？
